...
<body class="materialdesign">
                              ...
                              <div class="sparkline8-graph">
                                  <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="tblLog"
                                      ...
                                      <thead>
                                        <tr>
                                          <th data-sortable="true" data-field="project.0" rowspan="2" data-tableexport-rowspan="2" >Project/CR/Task</th>
                                          <th data-sortable="true" data-field="activity.0" rowspan="2">Activity</th>
                                          <th colspan="6" id="activityDetailsId">Activity Details</th>
                                          <th data-formatter="formatActionItem" data-field="actionItem" rowspan="2" data-tableexport-value="Total Mandays Lost">Action</th>
                                          <th  data-sortable="true" data-field="total.0" rowspan="2" data-tableexport-value="Created On">Total Mandays Lost</th>

                                          <th data-field="dateCreated.0" rowspan="2" data-tableexport-value="Comment">Created On</th>
                                          <th data-formatter="formatComment" rowspan="2">Comment</th>
                                          <th data-formatter="format" data-align="center" rowspan="2" class="editDelete" data-tableexport-display="none" >Delete</th>
                                        </tr>
                                        <tr>
                                          <th  data-field="description.0" data-tableexport-value="boo"  data-tableexport-colspan="6">Activity Description</th>
                                          ...
                                          <th data-align="center" data-formatter="formatEditDeleteActDesc" class="editDelete" data-tableexport-value="Action" >Edit/Delete</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                      </tbody>
  ...
  <script src="js/datapicker/bootstrap-datepicker.js"></script>
    ...
    <script>
        ...
        if(row.loggedBy.length>1)
        {
          ...
          $.each(row.loggedBy,function (index,value) {
            ...
            data+=icoDeleteRec+" <tr>\
                      ...
                      <td style='text-align:center' class='editDelete'>"+icoEditDelete+"</td>\
                  </tr>";
      ...
      $("#tblLog").on("all.bs.table ",function(data){
        $.each(numLength,function (ind,value) {
            ...
            colexport=[0,1,8,9,10,11,12,13,14];
            $.each(col,function (i,v) {
                $("#tblLog").find("tr[data-index='"+ind+"']").find("td").eq(v).attr("rowspan",value);
            });
            // $.each(colexport,function (i,v) {
            //     $("#tblLog").find("tr[data-index='"+ind+"']").find("td").eq(v).attr("data-tableexport-rowspan",value);
            // });
    ...
    $("#tblLog").on("post-body.bs.table", function(){
      ...
      $("#tblLog > thead > tr:nth-child(1) > th:nth-child(3)").attr("data-tableexport-colspan", "5");
      $("#tblLog > thead > tr:nth-child(2) > th.editDelete").attr("data-tableexport-display", "none");
      $("#tblLog > thead > tr:nth-child(1) > th.editDelete").attr("data-tableexport-display", "none");
    });
