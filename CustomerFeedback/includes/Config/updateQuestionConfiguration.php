...
$update="UPDATE config
         SET question_type_lowerBound=".$conn->quote($_POST['txtLowerBound'])
         .", question_type_upperBound=".$conn->quote($_POST['txtUpperBound'])."
            , defaultLeftLabel=".$conn->quote($_POST['txtLeftlabel'])."
            , defaultRightLabel=".$conn->quote($_POST['txtRightLabel']);
