...
$update="UPDATE config
         SET timeOfExpiry=".$conn->quote($_POST['txtExpireTime'])."
          ,surveyExpiresIn=".$conn->quote($_POST['txtNumExpireDay'])."
         ,numDaysForReminderMail=".$conn->quote($_POST['txtNumReminderDays']);
