                                  ...
                                  <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table
                                      ...
                                      <thead>
                                          ...
                                          <th data-sortable="true" data-formatter="formatProject" data-field="project">Project</th>
                ...
                <div class="modal-body">
                  <form id="frmAddProject">
                    <div class="form-group">
                      <label for="drpProject" class="col-sm-2 control-label">Choose Project</label>
                      <div class="col-sm-10">
