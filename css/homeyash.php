...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
    ...
    <title>Widgets | Adminpro - Admin Template</title>
          ...
          <nav id="sidebar">
              ...
              <div class="left-custom-menu-adp-wrap">
                  <ul class="nav navbar-nav left-sidebar-menu-pro">
                      <li class="nav-item">
                          <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fas big-icon fa-poll-h"></i> <span class="mini-dn">Home</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                          ...
                          <div class="col-lg-6 col-md-4 col-sm-7 col-xs-7">
                              <div class="header-top-menu tabl-d-n">
                                  <ul class="nav navbar-nav mai-top-nav">
                                      ...
                                      <li class="nav-item"><a href="#" class="nav-link">Questions</a>
                                      </li>
                                      <li class="nav-item"><a href="#" class="nav-link">Templates</a>
                                      </li>
                                      <li class="nav-item"><a href="#" class="nav-link">Project/CR/Task</a>
                                      </li>
                                      <li class="nav-item"><a href="#" class="nav-link">Survey</a>
                                      </li>
                                  </ul>
                                ...
                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                  ...
                                  <li class="nav-item">
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                                <li><a href="#"><span class="adminpro-icon adminpro-settings author-log-ic"></span>Config</a>
                                                </li>
                                ...
                                <div class="income-dashone-pro">
                                    <div class="income-rate-total">
                                        <div class="price-adminpro-rate">
                                            <h3><span></span><span class="counter">20</span></h3>
                                        </div>
                                ...
                                <div class="sparkline7-list">
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            <h1>Ongoing <span class="res-ds-n">Surveys</span></h1>
                        ...
                        <div class="col-lg-6">
                          <div class="widget-flot-bg widget-ov-mg-t-30 widget-ov-mg-t-n-30 widget-ov-mg-t-l-30 shadow-reset nt-mg-b-30">
                              ...
                              <div class="flot-chart">
                                  <div class="flot-chart-content" id="flot-chart88" style="padding: 0px; position: relative;"><canvas class="flot-base" width="1002" height="92" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 1002px; height: 92px;"></canvas><canvas class="flot-overlay" width="1002" height="92" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 1002px; height: 92px;"></canvas></div>
                              </div>
                          </div>
                        </div>
                    </div>
